...
var _featureImage = require('./vue_components/featureImage.vue');
...
var _confirmModal = require('./vue_components/confirmModal.vue');
...
var _uploadButton = require('./vue_components/uploadButton.vue');
...
new Vue({
    ...
    events: {
         ...
         * @param data
         */
        confirmationRequested: function confirmationRequested(data) {
    ...
    methods: {
         ...
         */
        requestMediaManager: function requestMediaManager() {
...
module.exports = {
    ...
    methods: {
         ...
         */
        sendResult: function sendResult(answer) {
            this.display = 'none';
...
module.exports = {
    ...
    methods: {
         ...
         */
        changeDirectoryUpLevel: function changeDirectoryUpLevel() {
         ...
         */
        changeDirectoryToHome: function changeDirectoryToHome() {
...
module.exports = {
    ...
    methods: {
         ...
         */
        refreshFiles: function refreshFiles(directory) {
            this.loading = true;
         ...
         */
        selectedFile: function selectedFile(selected_file, proceed) {
...
var _filesComponent = require('./filesComponent.vue');
...
module.exports = {
    ...
    events: {
         ...
         */
        fileSelected: function fileSelected(response) {
    ...
    methods: {
         ...
         */
        mediaSubmit: function mediaSubmit() {
